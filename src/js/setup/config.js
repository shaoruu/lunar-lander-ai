...
const HILLS_AMPLITUDE_FACTOR = 0.04
...
const SPEED_WEIGHT = -1.1
const ANGLE_DIFF_WEIGHT = 1.1
const TIME_WEIGHT = 0.0001
const TARGET_WEIGHT = 0.03
const CRASH_HILL_PENALTY = -10
const CRASH_BORDER_PENALTY = -20
